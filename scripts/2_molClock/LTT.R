...
files = list(table1="mcmcTree/MC07/step2_25burnin/all_filtered_align-linsi_trim05_MC7_mcmc_annot_LTT.tsv",
			 factor1 = -100,
			 table2="beast2/MC08/all_filtered_align-linsi_trim05_beast2_mc08_mcmc_annot_LTT-data.tsv",
			 factor2 = 1,
			 out = "all_filtered_align-linsi_trim05_combined-MCMCtree7-beast28.pdf")
