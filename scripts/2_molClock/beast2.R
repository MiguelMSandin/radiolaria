...
#----
setwd("~/Desktop/PhD/0_Thesis/2_chapter/data/molClock_filtered/beast2/MC08/")
#----
#---- Set file names -------------------------------------------------------------------------------

rm(list=ls()[!ls() %in% c("files")])

files = list(trees = "all_filtered_align-linsi_trim05_beast2_mc08.trees",
			 tree = "all_filtered_align-linsi_trim05_beast2_mc08_mcmc_annot.tre",
			 log = "all_filtered_align-linsi_trim05_beast2_mc08.log",
			 nodeHeights="all_filtered_align-linsi_trim05_beast2_mc08_summary_nodeHeights.tsv",
			 calibrations = "../calibrations_mc08.tsv",
			 plot="all_filtered_align-linsi_trim05_beast2_mc08")
